package com.ckaroses.dto.MatchHistory;
...
public class ParticipantStats implements Serializable {
	...
	private static final long serialVersionUID = -1089346022812989692L;
	private boolean winner, firstBloodAssist, firstBloodKill, 
				firstInhibitorAssist, firstInhibitorKill,firstTowerAssist,
				firstTowerKill;
	private long assists, champLevel, combatPlayerScore, deaths, 
				doubleKills, goldEarned, goldSpent, inhibitorKills, 
				...
				neutralMinionsKilledTeamJungle, nodeCapture, nodeCaptureAssist,
				nodeNeutralize, nodeNeutralizeAssist, objectivePlayerScore, 
				pentaKills, physicalDamageDealt, physicalDamageDealtToChampions,
				physicalDamageTaken, quadraKills, sightWardsBoughtInGame,
				teamObjective, totalDamageDealt, totalDamageDealtToChampions,
